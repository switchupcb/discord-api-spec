...
type AddUndefinedToPossiblyUndefinedPropertiesOfInterfaceStructure150357066914142204150357066913602205150357066910792206150357066905212 struct {
	Type                 string     `json:"type"`
	Properties           Properties `json:"properties"`
	Required             []string   `json:"required"`
	AdditionalProperties bool       `json:"additionalProperties"`
...
type AddUndefinedToPossiblyUndefinedPropertiesOfInterfaceAlias1589253880728677297015892538800215641DefAlias150357066910792206150357066905212857794829 struct {
	Type                 string     `json:"type"`
	Properties           Properties `json:"properties"`
	AdditionalProperties bool       `json:"additionalProperties"`
	Description          string     `json:"description"`
...
type AddUndefinedToPossiblyUndefinedPropertiesOfInterfaceStructure150357066935843677150357066935293678150357066934733678150357066931913679150357066905212 struct {
	Type                 string     `json:"type"`
	Properties           Properties `json:"properties"`
	AdditionalProperties bool       `json:"additionalProperties"`
	Description          string     `json:"description"`
